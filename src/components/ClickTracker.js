  ...
  render(){
    return(
      <div>
        ...
        <br />
        <Button name='1' clickHandler = { this.tracker } content={<img src={process.env.PUBLIC_URL+"number1.png"} height= '30px' alt='Numero 1' /> } />
        <Button name='2' clickHandler = { this.tracker } content={<img src={process.env.PUBLIC_URL+"number2.png"} height= '30px' alt='Numero 2' /> } />
        <Button name='3' clickHandler = { this.tracker } content={<img src={process.env.PUBLIC_URL+"number3.png"} height= '30px' alt='Numero 3' /> } />
